from app.clients.pokemon_client import get_pokemon_attack
...
def adapt_data_pokemon():
    ...
    spritesList = []
    for sprite in pokemonData["sprites"]:
        if sprite == "front_default" or sprite == "back_default" or sprite == "front_shiny" or sprite == "back_shiny":
